...
import { Users, NotePencil, Clock, CheckCircle, CaretLeft, CaretRight, Plus } from '@phosphor-icons/react'
    ...
    <div className={u.detailRoot}>
      ...
      <section className={u.surfaceCard}>
        <div className={u.cardHeaderBar}>
          ...
          {submission && !showRespondForm ? <button className={u.primaryBtn} onClick={() => handleOpenRespond(true)}>Chỉnh sửa</button> : null}
        </div>
        <div className={u.cardBody}>
          {submissionLoading ? (
            ...
            <div className={u.submissionView}>
              ...
              <div className={u.readonlyBlock}>
                <div className={u.readonlyLabel}><NotePencil size={18} weight="bold" /> Nội dung phản hồi từ đơn vị</div>
